...
export default function ChildQuestions({ question, onSelect, previousAnswer, handleNextStep, hasNextStep, step, handleSubmitQuiz}) {
                ...
                <div className={styles.emojis}>
                  <div className={styles.emojisBold}>
                    <Image
                      ...
                      tabIndex={1}
                      onKeyDown={(e) => handleKeyDown(e, "Awful")}
                    />
                    <Image
                      ...
                      tabIndex={2}
                      onKeyDown={(e) => handleKeyDown(e, "Bad")}
                    />
                    <Image
                      ...
                      tabIndex={3}
                      onKeyDown={(e) => handleKeyDown(e, "Decent")}
                    />
                    <Image
                    ...
                    <Image
                      ...
                      tabIndex={5}
                      onKeyDown={(e) => handleKeyDown(e, "Amazing")}
                    />
                  </div>
                </div>
              </>
              ...
              <div className={styles.emojisEmotion}>
                <div className={styles.emotionContainer}>
                  <Image
                    ...
                    tabIndex={1}
                    onKeyDown={(e) => handleKeyDown(e, "Joy")}
                  />
                  <Image
                    ...
                    tabIndex={2}
                    onKeyDown={(e) => handleKeyDown(e, "Sadness")}
                  />
                </div>
                <div className={styles.emotionContainer}>
                  <Image
                    ...
                    tabIndex={3}
                    onKeyDown={(e) => handleKeyDown(e, "Anger")}
                  ...
                  <Image
                    ...
                    tabIndex={4}
                    onKeyDown={(e) => handleKeyDown(e, "Fear")}
                  />
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div className={styles.multiSelectContainer}>
                ...
                <div
                  ...
                  tabIndex={1}
                  onKeyDown={(e) => handleKeyDown(e, "Happy")}
                >
                  Happy
                </div>
                <div
                  ...
                  tabIndex={2}
                  onKeyDown={(e) => handleKeyDown(e, "Optimistic")}
                >
                  Optimistic
                </div>
                <div
                  ...
                  tabIndex={3}
                  onKeyDown={(e) => handleKeyDown(e, "Excited")}
                >
                  Excited
                </div>
                <div
                  ...
                  tabIndex={4}
                  onKeyDown={(e) => handleKeyDown(e, "Proud")}
                >
                  Proud
                </div>
                <div
                  ...
                  tabIndex={5}
                  onKeyDown={(e) => handleKeyDown(e, "Bliss")}
                >
                  Bliss
                </div>
                <div
            ...
            <>
              ...
              <div className={styles.multiSelectContainer}>
                ...
                <div
                  ...
                  tabIndex={1}
                  onKeyDown={(e) => handleKeyDown(e, "Grief")}
                >
                  Grief
                </div>
                <div
                  ...
                  tabIndex={2}
                  onKeyDown={(e) => handleKeyDown(e, "Lonely")}
                >
                  Lonely
                </div>
                <div
                  ...
                  tabIndex={3}
                  onKeyDown={(e) => handleKeyDown(e, "Melancholic")}
                >
                  Melancholic
                </div>
                <div
                  ...
                  tabIndex={4}
                  onKeyDown={(e) => handleKeyDown(e, "Despair")}
                >
                  Despair
                </div>
                <div
                  ...
                  tabIndex={5}
                  onKeyDown={(e) => handleKeyDown(e, "Regret")}
                >
                  Regret
                </div>
                <div
                  ...
                  tabIndex={6}
                  onKeyDown={(e) => handleKeyDown(e, "Disappointed")}
                >
                  Disappointed
                </div>
              </div>
            ...
            <>
              ...
              <div className={styles.multiSelectContainer}>
                ...
                <div
                  ...
                  tabIndex={1}
                  onKeyDown={(e) => handleKeyDown(e, "Nervous")}
                >
                  Nervous
                </div>
                <div
                  ...
                  tabIndex={2}
                  onKeyDown={(e) => handleKeyDown(e, "Dread")}
                >
                  Dread
                </div>
                <div
                  ...
                  tabIndex={3}
                  onKeyDown={(e) => handleKeyDown(e, "Panic")}
                >
                  Panic
                </div>
                <div
                  ...
                  tabIndex={4}
                  onKeyDown={(e) => handleKeyDown(e, "Anxiety")}
                >
                  Anxiety
                </div>
                <div
                  ...
                  tabIndex={5}
                  onKeyDown={(e) => handleKeyDown(e, "Unease")}
                >
                  Unease
                </div>
                <div
                  ...
                  tabIndex={6}
                  onKeyDown={(e) => handleKeyDown(e, "Fright")}
                >
                  Fright
                </div>
              </div>
            ...
            <>
              ...
              <div className={styles.multiSelectContainer}>
                ...
                <div
                  ...
                  tabIndex={1}
                  onKeyDown={(e) => handleKeyDown(e, "Rage")}
                >
                  Rage
                </div>
                <div
                  ...
                  tabIndex={2}
                  onKeyDown={(e) => handleKeyDown(e, "Frustrated")}
                >
                  Frustrated
                </div>
                <div
                  ...
                  tabIndex={3}
                  onKeyDown={(e) => handleKeyDown(e, "Irritated")}
                >
                  Irritated
                </div>
                <div
                  ...
                  tabIndex={4}
                  onKeyDown={(e) => handleKeyDown(e, "Resented")}
                >
                  Resented
                </div>
                <div
                  ...
                  tabIndex={5}
                  onKeyDown={(e) => handleKeyDown(e, "Envy")}
                >
                  Envy
                </div>
                <div
                  ...
                  tabIndex={6}
                  onKeyDown={(e) => handleKeyDown(e, "Hatred")}
                >
                  Hatred
                </div>
              </div>
