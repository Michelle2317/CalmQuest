             ...
             <div className={styles.questionDescription}>Which emotion do you feel most intensely?</div>
              <div className={styles.emojisEmotion}>
                <Image
                  ...
                  width={100}
                  height={100}
                  className={`${styles.emotionRegular} ${isClicked && selectedOption === "Joy" ? styles.selectedEmoji : ""}`}
                ...
                <Image
                  ...
                  width={100}
                  height={100}
                  className={`${styles.emotionRegular} ${selectedOption === "Sadness" ? styles.selectedEmoji : styles.emotionRegular}`}
