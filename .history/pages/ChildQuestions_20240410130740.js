        ...
        <div className={styles.mainContainer}>
          ...
          {question === "What’s taking up most of your headspace right now?" && (
            <>
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "Work" ? "/images/headspace/work.svg" : styles.selectedEmoji}
                    alt="Work"
                    width={80}
                    height={80}
                ...
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "Family" ? "/images/headspace/Family.svg" : styles.selectedEmoji}
                    alt="Family"
                    width={80}
                    height={80}
                ...
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "School" ? "/images/headspace/school.svg" : styles.selectedEmoji}
                    alt="School"
                    width={80}
                    height={80}
                ...
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "Relationships" ? "/images/headspace/Relationships.svg" : styles.selectedEmoji}
                    alt="Relationships"
                    width={80}
                    height={80}
