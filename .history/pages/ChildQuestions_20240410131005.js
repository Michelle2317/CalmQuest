        ...
        <div className={styles.mainContainer}>
          ...
          {question === "What’s taking up most of your headspace right now?" && (
            <>
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "Work" ? styles.selectedEmoji : "/images/headspace/work.svg"}
                    alt="Work"
                    width={80}
                    height={80}
                    onClick={() => handleOptionSelect("Work")}
                  />
                  <div className={styles.headspaceText}></div>
                </div>
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "Family" ? styles.selectedEmoji : "/images/headspace/house.svg"}
                    alt="Family"
                    width={80}
                    height={80}
                ...
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "School" ? styles.selectedEmoji : "/images/headspace/school.svg"}
                    alt="School"
                    width={80}
                    height={80}
                ...
                <div className={styles.emojis}>
                  <Image
                    src={selectedOption === "Relationships" ? styles.selectedEmoji :  "/images/headspace/relationships.svg"}
                    alt="Relationships"
                    width={80}
                    height={80}
