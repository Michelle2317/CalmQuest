               ...
               <div className={styles.emojis}>
                <div className={styles.emojisBold}>
                  <Image
                    ...
                    className={selectedOption === "Awful" ? styles.selected : ""}
                  />
                  <Image
                    ...
                    className={selectedOption === "Bad" ? styles.selected : ""}
                  />
                  <Image
                    ...
                    className={selectedOption === "Decent" ? styles.selected : ""}
                  />
                  <Image
                    ...
                    className={selectedOption === "Good" ? styles.selected : ""}
                  />
                  <Image
                    ...
                    className={selectedOption === "Amazing" ? styles.selected : ""}
                  />
                </div>
              </div>
            </>
          ...
          {question === "Describe your feelings?" && previousAnswer && (
            <>
              <div className={styles.multiSelectContainer}>
                <div
                  className={`${styles.rectangle} ${selectedOption === "Happy" ? styles.selected : ""}`}
                  onClick={() => handleOptionSelect("Happy")}
                >
                  Happy
                </div>
                <div
                  className={`${styles.rectangle} ${selectedOption === "Optimistic" ? styles.selected : ""}`}
                  onClick={() => handleOptionSelect("Optimistic")}
                >
                  Optimistic
                </div>
                <div
                  className={`${styles.rectangle} ${selectedOption === "Excited" ? styles.selected : ""}`}
