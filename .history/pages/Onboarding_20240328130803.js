    ...
    <>
      ...
      <main className={`${styles.main}`}>
        ...
        <Image
          ...
          {currentScreen < 3 && (
            <ButtonPrimary className={styles.getStartedButton} title="Next" onClick={ {currentScreen === 0 && screen1()}
          {currentScreen === 1 && screen2()}
          {currentScreen === 2 && screen3()}
          {currentScreen === 3 && screen4()}
          {currentScreen < 3 && (
            <ButtonPrimary className={styles.getStartedButton} title="Next" onClick={handleGetStartedClick} />
          )}
          {currentScreen === 3 && (
