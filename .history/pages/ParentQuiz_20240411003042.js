...
export default function ParentQuiz() {
  ...
  const handleNextStep = () => {
    if (step < 4) {
      ...
      calculateOutcome(); // Moved the call to calculateOutcome here
    }
  };
  ...
  const handleSubmitQuiz = () => {
    setQuizComplete(true);
    calculateOutcome(); // Moved the call to calculateOutcome here as well
  };
      ...
      <main className={styles.main}>
        <div className={styles.mainContainer}>
          ...
          <div className={styles.buttonContainer}>
            {step > 1 && !quizComplete && (
              <button className={`${styles.secondaryButtonQuiz}`} onClick={handlePreviousStep} tabIndex="0">
                Back
              </button>
            )}
            {!quizComplete ? (
