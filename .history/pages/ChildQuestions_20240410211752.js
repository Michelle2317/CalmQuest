    ...
    <>
      ...
      <main className={`${styles.main}`}>
        <div className={styles.mainContainer}>
          ...
          {question === "Describe your feelings?" && previousAnswer && (
            <>
              {selectedOption === "Joy" && (
                <>
            <div className={styles.questionTwoDescription}>Tap any words that best describes how you are feeling</div>
        ...
        {selectedOption === "Sadness" && (
          <>
            <div className={styles.questionDescription}>Tap any words that best describe how you are feeling</div>
            <div className={styles.multiSelectContainer}>
              <div
