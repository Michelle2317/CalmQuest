...
export default function ParentQuiz() {
  ...
  const handleAnswerSelect = (answer) => {
    ...
    if (totalScore >= 0 && totalScore <= 3) {
        message = `You're doing great about your ${headspace.toLowerCase}! Keep it up!`;
    } else if (totalScore > 3 && totalScore <= 6) {
        message = `You're doing fantastic about your ${headspace.toLowerCase}! Keep up the good work!`;
