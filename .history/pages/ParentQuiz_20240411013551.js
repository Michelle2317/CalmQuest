  ...
  const handleAnswerSelect = (answer) => {
    ...
    switch (step) {
        ...
        case 2:
            ...
            break;
        default:
            // No points assigned for step 3 and 4
            break;
    }
    ...
    // Update the outcome if necessary
    if (step === 4) {
        calculateOutcome();
    }
    ...
    if (totalScore >= 0 && totalScore <= 3) {
        ...
        message = `It sounds like you're having a tough time with your ${headspace}. Consider seeking professional help services.`;
