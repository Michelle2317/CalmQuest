      ...
      <main className={`${styles.main}`}>
        ...
        {question === "Describe your feelings?" && previousAnswer && (
          <>
            ...
            <div className={`${styles.rectangle} ${selectedOptions.includes("Happy") ? styles.selected : ""}`}
            ...
            <div
              className={`${styles.rectangle} ${selectedOptions.includes("Proud") ? styles.selected : ""}`}
              onClick={() => handleMultiSelect("Proud")}
            >
              Proud
            </div>
            <div
              className={`${styles.rectangle} ${selectedOptions.includes("Bliss") ? styles.selected : ""}`}
              onClick={() => handleMultiSelect("Bliss")}
            >
              Bliss
            </div>
            <div
              className={`${styles.rectangle} ${selectedOptions.includes("Content") ? styles.selected : ""}`}
