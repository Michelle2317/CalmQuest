...
import ButtonPrimaryPrimary from "@/components/ButtonPrimaryPrimary";
import ButtonPrimarySecondary from "@/components/ButtonPrimarySecondary";
    ...
    <>
      ...
      <main className={`${styles.main}`}>
        <div className={styles.mainContainer}>
          ...
          />
          {currentScreen === 0 && (
            <ButtonPrimary className={styles.getStartedButtonPrimary} onClick={getStartedClick}>Get Started</ButtonPrimary>
          )}
          ...
          {currentScreen > 0 && currentScreen < 4 && (
            <ButtonPrimary className={styles.getStartedButtonPrimary} onClick={nextClick}>Next</ButtonPrimary>
          )}
          {currentScreen === 4 && (
          <Link href="/">
            <ButtonPrimary className={styles.getStartedButtonPrimary}>Let's Go!</ButtonPrimary>
          </Link>
          )}
        </div>        
      </main>
