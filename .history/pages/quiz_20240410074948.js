    ...
    <>
      ...
      <main className={`${styles.main}`}>
        <div className={styles.mainContainer}>
                <Navbar />
                <div className=" style={{left: 68, top: 279, position: 'absolute', color: 'black', fontSize: 32, fontFamily: 'Merriweather', fontWeight: '400', wordWrap: 'break-word'}}>How are you today?</div>
