    ...
    <>
      ...
      <main className={`${styles.main}`}>
        <div className={styles.mainContainer}>
          ...
          />
          {currentScreen === 0 && (
            <ButtonPrimary className={styles.getStartedButton} onClick={getStartedClick}>Get Started</button>
          )}
          ...
          {currentScreen > 0 && currentScreen < 4 && (
            <ButtonPrimary className={styles.getStartedButton} onClick={nextClick}>Next /</ButtonPrimary>>
          )}
          {currentScreen === 4 && (
          <Link href="/">
            <ButtonPrimaryPrimary className={styles.getStartedButton} title="Let's Go!" />
          </Link>
          )}
        </div>        
      </main>
