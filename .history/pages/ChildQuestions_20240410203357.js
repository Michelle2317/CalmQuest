        ...
        {question === "Describe your feelings?" && previousAnswer && (
          <>
            ...
            <div className={styles.multiSelectContainer}>
              ...
              <div
                className={`${styles.rectangle} ${selectedOption === "Bliss" ? styles.selectedEmoji : ""}`}
                onClick={() => handleOptionSelect("Bliss")}
              >
                Bliss
              </div>
              <div
                className={`${styles.rectangle} ${selectedOption === "Content" ? styles.selectedEmoji : ""}`}
