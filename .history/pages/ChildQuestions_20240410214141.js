...
export default function ChildQuestions({ question, onSelect, previousAnswer, handleNextStep }) {
  ...
  return (
   ...
   <h2 className={`${styles.questionThree} ${question === "What's taking up most of your headspace right now?"}`}></h2>
    {className={`${styles.questionThree}question === "What's taking up most of your headspace right now?" && (
      <>
        <div className={styles.emojisEmotion}>
          <div className={styles.emotionContainer}>
            <Image
