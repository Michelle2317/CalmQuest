    ...
    <>
      ...
      <main className={`${styles.main}`}>
        <div className={styles.mainContainer}>
          ...
          />
          {currentScreen === 0 && (
            <ButtonPrimary className={styles.getStartedButton} onClick={getStartedClick} title="Get Started"</button>
          )}
          ...
          {currentScreen > 0 && currentScreen < 4 && (
            <ButtonPrimary className={styles.getStartedButton} onClick={nextClick} title="Next" />
          )}
          {currentScreen === 4 && (
          <Link href="/">
