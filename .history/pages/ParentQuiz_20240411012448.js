...
export default function ParentQuiz() {
  ...
  const calculateOutcome = () => {
    ...
    if (totalScore >= 0 && totalScore <= 3) {
      setOutcome(`You are doing a great job in your ${headspace.toLowerCase()}! Keep it up and you'll do wonders!`);
    } else if (totalScore > 3 && totalScore <= 6) {
      setOutcome(`You're doing great about your ${headspace.toLowerCase()}! Keep up the good work!`);
    } else if (totalScore >= -7 && totalScore <= -5.5) {
      setOutcome(`It sounds like you're having a tough time with your ${headspace.toLowerCase()}. Consider seeking professional help.`);
    } else if (totalScore > -5 && totalScore <= -3) {
      setOutcome(`It sounds like you're struggling with your ${headspace.toLowerCase()}. Try some mental exercises to improve your mood.`);
    } else if (totalScore > -2.5 && totalScore < 0) {
      setOutcome(`It seems like you're having a bit of difficulty with your ${headspace.toLowerCase()}. Mental exercises might help.`);
    }
  };
